...
namespace VNCScreen
{
    ...
    /// 
    /// </summary>
    public class VNCControllerRaycaster : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (vnc != null)
            {
                ...
                vnc.UpdateMouse(uvPos, OVRInput.Get(OVRInput.Button.One), OVRInput.Get(OVRInput.Touch.Two), OVRInput.Get(OVRInput.RawButton.RIndexTrigger));
                showCursor(false);
            }
            else
                showCursor(true);
